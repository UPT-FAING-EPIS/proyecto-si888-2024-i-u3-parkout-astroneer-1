...
{
    [Tooltip("Controls how much the camera will move in response to detect mouse input.")]
    [SerializeField] private float sensitivity = 2f;
    [Tooltip("Controls how much the camera will continue to move after mouse input ceaces.")]
